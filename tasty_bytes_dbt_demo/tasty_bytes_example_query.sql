...
execute dbt project from workspace USER$.PUBLIC."dbt-on-snowflake" project_root='tasty_bytes_dbt_demo' args='compile --select raw_pos_country.sql  --target dev '>> examples/output.sql